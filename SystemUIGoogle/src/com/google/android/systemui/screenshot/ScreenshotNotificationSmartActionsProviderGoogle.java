...
public final class ScreenshotNotificationSmartActionsProviderGoogle
    ...
    private static final ImmutableMap SCREENSHOT_OP_MAP =
            ImmutableMap.builder()
                    ...
                    .build();
    private static final ImmutableMap SCREENSHOT_OP_STATUS_MAP =
            ImmutableMap.builder()
                    .put(
                    ...
                    .build();
    private static final ImmutableMap SCREENSHOT_INTERACTION_TYPE_MAP =
            ImmutableMap.builder()
                    .put(
                            ScreenshotNotificationSmartActionsProvider.ScreenshotSmartActionType
    ...
    public CompletableFuture<List<Notification.Action>> getActions(
        ...
        final CompletableFuture<List<Notification.Action>> completableFuture =
                new CompletableFuture<>();
        if (bitmap.getConfig() != Bitmap.Config.HARDWARE) {
            Log.e(
                    "ScreenshotActionsGoogle",
                    String.format(
        ...
        Log.d(
                "ScreenshotActionsGoogle",
                "Calling AiAi to obtain screenshot notification smart actions.");
        mClient.provideScreenshotActions(
                ...
                userHandle,
                (SuggestParcelables_InteractionType)
                        SCREENSHOT_INTERACTION_TYPE_MAP.getOrDefault(
                                screenshotSmartActionType,
                                SuggestParcelables_InteractionType.SCREENSHOT_NOTIFICATION),
                new ContentSuggestionsServiceWrapper.BundleCallback() {
                    ...
                    public void onResult(Bundle bundle) {
                        ...
                        Log.d(
                                "ScreenshotActionsGoogle",
                                String.format(
                                        "Total time taken to get smart actions: %d ms",
    ...
    public void notifyOp(
            String str,
            ScreenshotNotificationSmartActionsProvider.ScreenshotOp screenshotOp,
            ScreenshotNotificationSmartActionsProvider.ScreenshotOpStatus screenshotOpStatus,
            long j) {
        mClient.notifyOp(
                str,
                (FeedbackParcelables_ScreenshotOp)
                        SCREENSHOT_OP_MAP.getOrDefault(
                                screenshotOp, FeedbackParcelables_ScreenshotOp.OP_UNKNOWN),
                (FeedbackParcelables_ScreenshotOpStatus)
                        SCREENSHOT_OP_STATUS_MAP.getOrDefault(
                                screenshotOpStatus,
                                FeedbackParcelables_ScreenshotOpStatus.OP_STATUS_UNKNOWN),
                j);
    }
    ...
    void completeFuture(
            Bundle bundle, CompletableFuture<List<Notification.Action>> completableFuture) {
        if (bundle.containsKey("ScreenshotNotificationActions")) {
            completableFuture.complete(
                    bundle.getParcelableArrayList("ScreenshotNotificationActions"));
        } else {
