...
interface GoogleQSModule {
    ...
    /** Inject OverlayToggleTile into tileMap in QSModule */
    @Binds
    @IntoMap
    @StringKey(OverlayToggleTile.TILE_SPEC)
    fun bindOverlayToggleTile(overlayToggleTile: OverlayToggleTile): QSTileImpl<*>

    /** Inject BatterySaverTileGoogle into tileMap in QSModule */
    @Binds
    @IntoMap
    @StringKey(RotationLockTileGoogle.TILE_SPEC)
    fun bindRotationLockTileGoogle(rotationLockTileGoogle: RotationLockTileGoogle): QSTileImpl<*>
}
