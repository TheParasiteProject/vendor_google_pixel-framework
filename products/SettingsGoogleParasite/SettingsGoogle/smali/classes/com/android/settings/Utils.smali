...
# direct methods
.method public static synthetic $r8$lambda$JXYguPGVMAafrXql8qC9NSVa4ok(Landroid/content/Context;)Ljava/lang/String;
    .locals 0

    .line 0
    invoke-static {p0}, Lcom/android/settings/Utils;->lambda$getConfirmCredentialStringForUser$1(Landroid/content/Context;)Ljava/lang/String;
...
.method public static synthetic $r8$lambda$PEWZ1ieaMCMUJWQlo9zeDBg2JlA(Landroid/content/Context;)Ljava/lang/String;
    .locals 0

    .line 0
    invoke-static {p0}, Lcom/android/settings/Utils;->lambda$getConfirmCredentialStringForUser$2(Landroid/content/Context;)Ljava/lang/String;
...
.method public static synthetic $r8$lambda$zZ-x6OiGPIsQS_yqSv5wv7I47oo(Landroid/content/Context;)Ljava/lang/String;
    .locals 0

    .line 0
    invoke-static {p0}, Lcom/android/settings/Utils;->lambda$getConfirmCredentialStringForUser$0(Landroid/content/Context;)Ljava/lang/String;
...
.method public static areDreamsAvailableToCurrentUser(Landroid/content/Context;)Z
    ...
    const v1, 0x111013c    # @android:bool/config_earcFeatureEnabled_default
    ...
    const v2, 0x111013b    # @android:bool/config_earcFeatureEnabled_allowed
...
.method public static forceCustomPadding(Landroid/view/View;Z)V
    ...
    :goto_1
    const v3, 0x105024b    # @android:dimen/preference_fragment_padding_side_material
...
.method public static getConfirmCredentialStringForUser(Landroid/content/Context;II)Ljava/lang/String;
    ...
    new-instance p2, Lcom/android/settings/Utils$$ExternalSyntheticLambda2;

    invoke-direct {p2, p0}, Lcom/android/settings/Utils$$ExternalSyntheticLambda2;-><init>(Landroid/content/Context;)V
    ...
    new-instance p2, Lcom/android/settings/Utils$$ExternalSyntheticLambda0;

    invoke-direct {p2, p0}, Lcom/android/settings/Utils$$ExternalSyntheticLambda0;-><init>(Landroid/content/Context;)V
    ...
    new-instance p2, Lcom/android/settings/Utils$$ExternalSyntheticLambda1;

    invoke-direct {p2, p0}, Lcom/android/settings/Utils$$ExternalSyntheticLambda1;-><init>(Landroid/content/Context;)V
...
.method private static synthetic lambda$getConfirmCredentialStringForUser$0(Landroid/content/Context;)Ljava/lang/String;
    .locals 1
...
.method private static synthetic lambda$getConfirmCredentialStringForUser$1(Landroid/content/Context;)Ljava/lang/String;
    .locals 1
...
.method private static synthetic lambda$getConfirmCredentialStringForUser$2(Landroid/content/Context;)Ljava/lang/String;
    .locals 1
