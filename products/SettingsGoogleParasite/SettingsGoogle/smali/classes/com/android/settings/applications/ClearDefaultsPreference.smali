...
.method public updateUI(Landroidx/preference/PreferenceViewHolder;)Z
    ...
    iget-object v2, p0, Lcom/android/settings/applications/ClearDefaultsPreference;->mAppEntry:Lcom/android/settingslib/applications/ApplicationsState$AppEntry;
    ...
    .line 143
    iget-object v2, p0, Lcom/android/settings/applications/ClearDefaultsPreference;->mPm:Landroid/content/pm/PackageManager;
    ...
    iget-object v5, p0, Lcom/android/settings/applications/ClearDefaultsPreference;->mPackageName:Ljava/lang/String;

    invoke-static {v2, v5}, Lcom/android/settingslib/applications/AppUtils;->isDefaultBrowser(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v2

    if-nez v2, :cond_1

    iget-object v2, p0, Lcom/android/settings/applications/ClearDefaultsPreference;->mUsbManager:Landroid/hardware/usb/IUsbManager;
    ...
    .line 152
    sget v6, Lcom/android/settings/R$string;->auto_launch_label_generic:I
    ...
    .line 154
    :cond_4
    sget v6, Lcom/android/settings/R$string;->auto_launch_label:I
    ...
    .line 162
    sget v2, Lcom/android/settings/R$string;->auto_launch_enable_text:I
    ...
    invoke-virtual {v9, v10, v4, v2, v4}, Landroid/text/SpannableString;->setSpan(Ljava/lang/Object;III)V
    ...
    .line 172
    sget v1, Lcom/android/settings/R$string;->always_allow_bind_appwidgets_text:I
    ...
    invoke-direct {v5, v7}, Landroid/text/style/BulletSpan;-><init>(I)V
    ...
    .line 176
    invoke-virtual {v6, v5, v4, v1, v4}, Landroid/text/SpannableString;->setSpan(Ljava/lang/Object;III)V
