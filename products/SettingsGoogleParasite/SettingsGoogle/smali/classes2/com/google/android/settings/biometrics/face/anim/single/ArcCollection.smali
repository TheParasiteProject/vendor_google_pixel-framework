...
# direct methods
.method public static synthetic $r8$lambda$1J_WNgJhCPFlzw4vBcrKSYU-87g(Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method public static synthetic $r8$lambda$hpzWevD844W2fud-ZbZXjcnREtY(Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method public static synthetic $r8$lambda$uXkbkQ61_ewb7QUpYN1hpOxlPnU(Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method public static synthetic $r8$lambda$v3gu5EnH_xFDj4WsQlIJUJlt51Y(Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method public static synthetic $r8$lambda$vO7akkkUrvWad13gbKnQVdkOooU(Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method public static synthetic $r8$lambda$vjt2qxdkZ4BUZJcyI84AwbFSSMY(Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method public startFinishing(Ljava/lang/Runnable;)V
    ...
    .line 189
    iget v3, p0, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;->mState:I
    ...
    .line 195
    iput v4, p0, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;->mState:I
    ...
    new-instance v6, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection$$ExternalSyntheticLambda4;

    invoke-direct {v6, p0}, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection$$ExternalSyntheticLambda4;-><init>(Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;)V
    ...
    new-instance v6, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection$2;

    invoke-direct {v6, p0, p1}, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection$2;-><init>(Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;Ljava/lang/Runnable;)V

    invoke-virtual {v3, v6}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 212
    iget p1, p0, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;->mSpeed:F
    ...
    invoke-virtual {p1, v4, v5}, Lcom/google/android/settings/biometrics/face/anim/single/RotatingArc;->startFinishing(J)V
...
.method public startRotating()V
    ...
    .line 156
    iget v2, p0, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;->mState:I
    ...
    .line 162
    iput v3, p0, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;->mState:I
    ...
    new-instance v6, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection$$ExternalSyntheticLambda2;

    invoke-direct {v6, p0}, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection$$ExternalSyntheticLambda2;-><init>(Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;)V
    ...
    iput-object v2, p0, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;->mSpeedAnimator:Landroid/animation/ValueAnimator;

    .line 173
    invoke-virtual {v2, v4, v5}, Landroid/animation/ValueAnimator;->setDuration(J)Landroid/animation/ValueAnimator;

    .line 174
    iget-object v2, p0, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;->mSpeedAnimator:Landroid/animation/ValueAnimator;

    new-instance v3, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection$$ExternalSyntheticLambda3;

    invoke-direct {v3, p0}, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection$$ExternalSyntheticLambda3;-><init>(Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;)V
    ...
    .line 180
    :goto_0
    iget-object v2, p0, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;->mArcs:Ljava/util/List;
    ...
    check-cast v2, Lcom/google/android/settings/biometrics/face/anim/single/RotatingArc;

    invoke-virtual {v2, v4, v5}, Lcom/google/android/settings/biometrics/face/anim/single/RotatingArc;->startRotating(J)V
...
.method public stopRotating()V
    ...
    new-instance v2, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection$$ExternalSyntheticLambda1;

    invoke-direct {v2, p0}, Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection$$ExternalSyntheticLambda1;-><init>(Lcom/google/android/settings/biometrics/face/anim/single/ArcCollection;)V
