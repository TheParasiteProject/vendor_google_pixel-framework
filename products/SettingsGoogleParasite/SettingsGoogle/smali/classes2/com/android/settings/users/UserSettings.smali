...
# direct methods
.method public static synthetic $r8$lambda$27Fj-1-oGrE_ZOWr1HbradY65QI(Lcom/android/settings/users/UserSettings;)V
    .locals 0
...
.method public static synthetic $r8$lambda$3NSoOFzb159ATny_03MRP_UPTEg(Lcom/android/settings/users/UserSettings;ILjava/lang/String;Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Landroid/content/Context;)V
    .locals 0
...
.method public static synthetic $r8$lambda$DFoTszoDVbU8E3SlLwDW8JM9_uA(Lcom/android/settings/users/UserSettings;Landroid/graphics/drawable/Drawable;Landroid/content/pm/UserInfo;Landroid/app/Activity;Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
    .locals 0
...
.method public static synthetic $r8$lambda$Tk3JV37593rPfkaOzgL40GTS-0I(Lcom/android/settings/users/UserSettings;)V
    .locals 0
...
.method public static synthetic $r8$lambda$WNYCWAFA3MYumgGhO3gDzY4A0Nk(Lcom/android/settings/users/UserSettings;Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Landroid/content/pm/UserInfo;)V
    .locals 0
...
.method public static synthetic $r8$lambda$bkpP7rhnHld0xC0zqcDm2JcFNxM(Lcom/android/settings/users/UserSettings;ILjava/lang/String;Landroid/graphics/drawable/Drawable;Ljava/lang/Boolean;)V
    .locals 0
...
.method public static synthetic $r8$lambda$ic6h5yp8OFM14Vpo14v7be99m5o(Landroid/content/pm/UserInfo;)Z
    .locals 0
...
.method public static synthetic $r8$lambda$l9VT0oSrIZK_mfOjb_kBnheDqFU(Lcom/android/settings/users/UserSettings;Landroid/content/pm/UserInfo;Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Landroid/content/Context;)V
    .locals 0
...
.method public static synthetic $r8$lambda$xznTHnjp4VKsO__Zlc909f1ITzs(Lcom/android/settings/users/UserSettings;Landroid/content/pm/UserInfo;Landroid/app/Activity;Landroid/graphics/drawable/Drawable;)V
    .locals 0
...
.method private buildAddUserDialog(I)Landroid/app/Dialog;
    ...
    new-instance v3, Lcom/android/settings/users/UserSettings$$ExternalSyntheticLambda8;

    invoke-direct {v3, p0}, Lcom/android/settings/users/UserSettings$$ExternalSyntheticLambda8;-><init>(Lcom/android/settings/users/UserSettings;)V
    ...
    new-instance v5, Lcom/android/settings/users/UserSettings$$ExternalSyntheticLambda10;

    invoke-direct {v5, p0, p1}, Lcom/android/settings/users/UserSettings$$ExternalSyntheticLambda10;-><init>(Lcom/android/settings/users/UserSettings;I)V

    new-instance v6, Lcom/android/settings/users/UserSettings$$ExternalSyntheticLambda11;

    invoke-direct {v6, p0}, Lcom/android/settings/users/UserSettings$$ExternalSyntheticLambda11;-><init>(Lcom/android/settings/users/UserSettings;)V
...
.method private buildEditCurrentUserDialog()Landroid/app/Dialog;
    ...
    new-instance v4, Lcom/android/settings/users/UserSettings$$ExternalSyntheticLambda8;

    invoke-direct {v4, p0}, Lcom/android/settings/users/UserSettings$$ExternalSyntheticLambda8;-><init>(Lcom/android/settings/users/UserSettings;)V
    ...
    invoke-direct {v6, p0, v3, v0, v1}, Lcom/android/settings/users/UserSettings$$ExternalSyntheticLambda9;-><init>(Lcom/android/settings/users/UserSettings;Landroid/graphics/drawable/Drawable;Landroid/content/pm/UserInfo;Landroid/app/Activity;)V
...
.method private synthetic lambda$createUser$9(ILjava/lang/String;Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Landroid/content/Context;)V
    ...
    .line 1037
    :goto_1
    new-instance p1, Lcom/android/settings/users/UserSettings$$ExternalSyntheticLambda6;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/settings/users/UserSettings$$ExternalSyntheticLambda6;-><init>(Lcom/android/settings/users/UserSettings;Landroid/content/pm/UserInfo;Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Landroid/content/Context;)V
...
.method private synthetic lambda$onAddGuestClicked$1(Landroid/content/Context;Lcom/android/settingslib/users/UserCreatingDialog;)V
    ...
    invoke-direct {v1, p0, p2, v0, p1}, Lcom/android/settings/users/UserSettings$$ExternalSyntheticLambda7;-><init>(Lcom/android/settings/users/UserSettings;Lcom/android/settingslib/users/UserCreatingDialog;Landroid/content/pm/UserInfo;Landroid/content/Context;)V
...
.method private updateAddGuestPreference(Landroid/content/Context;Z)Z
    ...
    sget v1, Lcom/android/settingslib/R$string;->guest_resetting:I
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const v2, 0x1110193    # @android:bool/config_letterboxIsEnabledForTranslucentActivities
...
.method updateUserList()V
    ...
    invoke-direct {v2}, Lcom/android/settings/users/UserSettings$$ExternalSyntheticLambda1;-><init>()V
    ...
    .line 1229
    invoke-virtual {v10, v5}, Landroidx/preference/Preference;->setSelectable(Z)V
    ...
    invoke-direct {v4, v5, v9, v7}, Lcom/android/settings/users/UserPreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
