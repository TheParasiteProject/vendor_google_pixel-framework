...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/systemui/broadcast/BroadcastDispatcher;Lcom/android/systemui/dump/DumpManager;Lcom/android/systemui/util/settings/GlobalSettings;Lcom/android/systemui/settings/UserTracker;)V
    ...
    .line 70
    invoke-interface {p5}, Lcom/android/systemui/util/settings/SettingsProxy;->getUserId()I
    ...
    .line 74
    invoke-interface {p5, v5, v1, p3, v6}, Lcom/android/systemui/util/settings/SettingsProxy;->registerContentObserverForUser(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V

    .line 75
    .line 76
    .line 77
    invoke-interface {p5, v1, v4}, Lcom/android/systemui/util/settings/SettingsProxy;->getInt(ILjava/lang/String;)I
    ...
    .line 86
    .line 87
    invoke-virtual {v3, p3}, Lcom/android/systemui/util/settings/GlobalSettingsImpl;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 95
    invoke-interface {p5, p3, v1, v2, v3}, Lcom/android/systemui/util/settings/SettingsProxy;->registerContentObserverForUser(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
    ...
    .line 136
    .line 137
    invoke-virtual {p6, v0, p1}, Lcom/android/systemui/settings/UserTrackerImpl;->addCallback(Lcom/android/systemui/settings/UserTracker$Callback;Ljava/util/concurrent/Executor;)V
