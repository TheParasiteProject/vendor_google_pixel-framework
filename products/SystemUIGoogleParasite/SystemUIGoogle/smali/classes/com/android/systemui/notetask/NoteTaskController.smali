...
.method public static final access$awaitShowNoteTaskAsUser(Lcom/android/systemui/notetask/NoteTaskController;Lcom/android/systemui/notetask/NoteTaskEntryPoint;Landroid/os/UserHandle;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 115
    .line 116
    invoke-direct {v11, v10, v6}, Lcom/android/systemui/notetask/NoteTaskBubblesController$areBubblesAvailable$2;-><init>(Lcom/android/systemui/notetask/NoteTaskBubblesController;Lkotlin/coroutines/Continuation;)V
    ...
    .line 176
    iget-object v12, v0, Lcom/android/systemui/notetask/NoteTaskController;->devicePolicyManager:Landroid/app/admin/DevicePolicyManager;

    .line 177
    .line 178
    invoke-virtual {v12, v6, v11}, Landroid/app/admin/DevicePolicyManager;->getKeyguardDisabledFeatures(Landroid/content/ComponentName;I)I
    ...
    .line 211
    :cond_a
    iget-object v11, v0, Lcom/android/systemui/notetask/NoteTaskController;->resolver:Lcom/android/systemui/notetask/NoteTaskInfoResolver;

    .line 212
    .line 213
    invoke-virtual {v11, v1, v4, v13}, Lcom/android/systemui/notetask/NoteTaskInfoResolver;->resolveInfo(Lcom/android/systemui/notetask/NoteTaskEntryPoint;ZLandroid/os/UserHandle;)Lcom/android/systemui/notetask/NoteTaskInfo;
    ...
    .line 248
    .line 249
    instance-of v11, v4, Lcom/android/systemui/notetask/NoteTaskLaunchMode$AppBubble;
    :try_end_1
    .catch Landroid/content/ActivityNotFoundException; {:try_start_1 .. :try_end_1} :catch_0

    .line 250
    .line 251
    iget-object v12, v0, Lcom/android/systemui/notetask/NoteTaskController;->context:Landroid/content/Context;
    ...
    .line 259
    const v4, 0x7f0808ae    # @drawable/ic_note_task_shortcut_widget 'res/drawable/ic_note_task_shortcut_widget.xml'
    ...
    .line 269
    .line 270
    iput-object v6, v2, Lcom/android/systemui/notetask/NoteTaskController$awaitShowNoteTaskAsUser$1;->L$1:Ljava/lang/Object;

    .line 271
    .line 272
    iput-object v6, v2, Lcom/android/systemui/notetask/NoteTaskController$awaitShowNoteTaskAsUser$1;->L$2:Ljava/lang/Object;

    .line 273
    .line 274
    iput v8, v2, Lcom/android/systemui/notetask/NoteTaskController$awaitShowNoteTaskAsUser$1;->label:I
    ...
    .line 287
    .line 288
    iget-object v1, v4, Lcom/android/systemui/notetask/NoteTaskBubblesController;->bgDispatcher:Lkotlinx/coroutines/CoroutineDispatcher;
    ...
    .line 381
    .line 382
    invoke-virtual {v12, v2, v13}, Landroid/content/Context;->startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
...
.method public final getUserForHandlingNotesTaking(Lcom/android/systemui/notetask/NoteTaskEntryPoint;)Landroid/os/UserHandle;
    ...
    .line 23
    .line 24
    invoke-interface {p0, v0, p1, p1}, Lcom/android/systemui/util/settings/SettingsProxy;->getIntForUser(Ljava/lang/String;II)I
...
.method public final showNoDefaultNotesAppToast()V
    ...
    .line 1
    const v0, 0x7f130824    # @string/set_default_notes_app_toast_content 'Set default notes app in Settings'
...
.method public final updateNoteTaskAsUser(Landroid/os/UserHandle;)V
    ...
    .line 30
    .line 31
    invoke-virtual {p0, p1}, Lcom/android/systemui/notetask/NoteTaskController;->updateNoteTaskAsUserInternal(Landroid/os/UserHandle;)V
...
.method public final updateNoteTaskAsUserInternal(Landroid/os/UserHandle;)V
    .locals 8
    ...
    .line 22
    .line 23
    iget-object v3, p0, Lcom/android/systemui/notetask/NoteTaskController;->roleManager:Landroid/app/role/RoleManager;

    .line 24
    .line 25
    invoke-virtual {v3, v1, p1}, Landroid/app/role/RoleManager;->getRoleHoldersAsUser(Ljava/lang/String;Landroid/os/UserHandle;)Ljava/util/List;
    ...
    .line 34
    .line 35
    iget-boolean v4, p0, Lcom/android/systemui/notetask/NoteTaskController;->isEnabled:Z
    ...
    .line 77
    .line 78
    const-class v7, Lcom/android/systemui/notetask/shortcut/CreateNoteTaskShortcutActivity;

    .line 79
    .line 80
    invoke-direct {v0, v4, v7}, Landroid/content/ComponentName;-><init>(Landroid/content/Context;Ljava/lang/Class;)V
    ...
    .line 88
    :goto_3
    invoke-virtual {v4, p1, v6}, Landroid/content/Context;->createContextAsUser(Landroid/os/UserHandle;I)Landroid/content/Context;
    ...
    .line 96
    invoke-virtual {v6, v0, v7, v5}, Landroid/content/pm/PackageManager;->setComponentEnabledSetting(Landroid/content/ComponentName;II)V
    ...
    .line 118
    invoke-virtual {p0, v0}, Landroid/content/pm/ShortcutManager;->enableShortcuts(Ljava/util/List;)V

    .line 119
    .line 120
    .line 121
    invoke-static {v3, v4, p1}, Lcom/android/systemui/notetask/NoteTaskRoleManagerExt;->createNoteShortcutInfoAsUser(Landroid/app/role/RoleManager;Landroid/content/Context;Landroid/os/UserHandle;)Landroid/content/pm/ShortcutInfo;
